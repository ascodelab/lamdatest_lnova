...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    fetch("https://api.exchangeratesapi.io/latest?base=INR").then(function () {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Price Widget")]),
      _vm._v(" "),
      _c("div", { staticClass: "flex mb-4 h-screen" }, [
        _c("div", { staticClass: "w-1/4 bg-grey h-12" }, [
          _c("h2", [_vm._v("INR")]),
          _vm._v(" "),
          _c("input", {
            directives: [
            ...
            staticClass: "p-2",
            attrs: { type: "number" },
            domProps: { value: _vm.inr },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.inr = $event.target.value
              }
            }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "w-1/4 bg-grey-light h-12" }, [
          _c("h2", [_vm._v("USD")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "p-2 bg-40",
            domProps: { value: _vm.inr * _vm.rates.USD }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "w-1/4 bg-grey h-12" }, [
          ...
          _c("input", {
            staticClass: "p-2 bg-40",
            domProps: { value: _vm.inr * _vm.rates.GBP }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "w-1/4 bg-grey-light h-12" }, [
          ...
          _c("input", {
            staticClass: "p-2 bg-40",
            domProps: { value: _vm.inr * _vm.rates.EUR }
          })
        ])
      ]),
      _vm._v("\n  " + _vm._s(_vm.rates) + "\n")
